...
WebUI.navigateToUrl(findTestData('DD_Login').getValue(1, 1))

WebUI.setText(findTestObject('Login/input_UserName'), findTestData('DD_Login').getValue(2, 1))

WebUI.setText(findTestObject('Login/input_Password'), findTestData('DD_Login').getValue(3, 1))

WebUI.click(findTestObject('Login/btnLogOn'))
